			...
			<div class="col-md-6">
				<div class="alert alert-warning">
					<p>
						...
						This app has been built by <a href="https://twitter.com/etsmo">@etsmo</a> for learninig purposes.</strong>
					</p>
				</div>
			</div>
		</div>

		<p>Feel free to help to impove the <a href="#">source code.</a></p>
